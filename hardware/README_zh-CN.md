...
<span style="color:red">UniArm</span> 可与宇树科技技术生态协同工作，例如配合 [unitree_lerobot](https://github.com/unitreerobotics/unitree_lerobot/tree/main) 构建操作与具身智能研究系统。
...
1. 购买非打印零部件，购买清单见[1.1 采购零件](#11-采购零件).
2. 将零件进行 3D 打印，具体说明见[1.2 打印零件](#12-打印零件).
